...
- [ ]   4. **Interactive Chrome verification**:
    ...
    Expected: exits 0 — zero overflow / console-error / font / Monaco-height failures across every route × 3 widths × 2 themes. Screenshots saved to `.tmp/verify-screens/`. If failures, use the live-browser inspection tools available in the current harness to inspect the root cause.
