...
const navGroups: NavGroup[] = [
    {
        ...
        items: [
            ...
            { itemName: 'Diff', itemLink: '/diff', icon: '△' },
            { itemName: 'HTML Editor', itemLink: '/html-editor', icon: '</>' },
            { itemName: 'JWT', itemLink: '/jwt', icon: '⊛' },
            { itemName: 'Cron', itemLink: '/cron', icon: '⏱' },
            { itemName: 'QR', itemLink: '/qr', icon: '⬛' },
