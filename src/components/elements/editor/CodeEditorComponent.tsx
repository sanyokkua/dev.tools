import CodeEditor, {
    ...
    EditorOnMount,
    EditorProperties,
} from '@/components/elements/editor/CodeEditor';
...
import { MenuButtonClickHandler } from '@/components/elements/menuBar/types';
...
const CodeEditorComponent: React.FC<CodeEditorProps> = ({
    ...
    const onFileNewClick: MenuButtonClickHandler = useCallback(() => {
    ...
    const onFileOpenClick: MenuButtonClickHandler = useCallback(() => {
        setOpenFileDialog(true);
    }, []);

    const onFileSaveClick: MenuButtonClickHandler = useCallback(() => {
    ...
    const onEditorWrapLinesClick: MenuButtonClickHandler = useCallback(() => {
        setEditorWordWrap((prev) => !prev);
    }, []);

    const onEditorMiniMapClick: MenuButtonClickHandler = useCallback(() => {
    ...
    return (
        <div className="layoutContentConfig">
