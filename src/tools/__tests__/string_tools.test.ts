...
describe('splitStringBy', () => {
    test('test empty or null(undefined) data passed to splitStringBy', () => {
        expect(splitStringBy(null, ',')).toStrictEqual([]);
        expect(splitStringBy(undefined, ',')).toStrictEqual([]);
        expect(splitStringBy('', ',')).toStrictEqual([]);
    });
    test('test null(undefined) splitter passed to splitStringBy', () => {
        const data = 'text\nsome\nlines';
        expect(() => splitStringBy(data, null)).toThrowError('Splitter is null or undefined');
        expect(() => splitStringBy(data, undefined)).toThrowError('Splitter is null or undefined');
    });
...
describe('getLinesFromString', () => {
    test('test empty or null(undefined) data passed to getLinesFromString', () => {
        expect(getLinesFromString(null)).toStrictEqual([]);
        expect(getLinesFromString(undefined)).toStrictEqual([]);
        expect(getLinesFromString('')).toStrictEqual([]);
    });
...
describe('sortStrings', () => {
    test('test empty or null(undefined) data passed to sortStrings', () => {
        expect(sortStrings(null)).toStrictEqual([]);
        expect(sortStrings(undefined)).toStrictEqual([]);
        expect(sortStrings([])).toStrictEqual([]);
    });
    test('test sortStrings works as expected with appropriate data', () => {
        ...
        expect(sortStrings(data4ascCase, SortingTypes.ASC_IGN_CASE)).toStrictEqual(expData4ascCase);
        expect(sortStrings(data5descCase, SortingTypes.DSC_IGN_CASE)).toStrictEqual(expData5descCase);
    });
});

describe('randomizeStringsOrder', () => {
    test('test empty or null(undefined) data passed to randomizeStringsOrder', () => {
        expect(randomizeStringsOrder(null)).toStrictEqual([]);
        expect(randomizeStringsOrder(undefined)).toStrictEqual([]);
        expect(randomizeStringsOrder([])).toStrictEqual([]);
    });
...
describe('removeDuplicates', () => {
    test('test empty or null(undefined) data passed to removeDuplicates', () => {
        ...
        expect(removeDuplicates(undefined)).toStrictEqual([]);
        expect(removeDuplicates([])).toStrictEqual([]);
    });
    test('test removeDuplicates works as expected with appropriate data', () => {
        const data1 = ['text'];
        const expData1 = ['text'];
        const data2 = ['1111', 'aaaa', '2222', 'GlOBAl', '1111', 'AAAA', 'ffffff', 'wwwww', 'ddddd', 'ww'];
        const expData2 = ['1111', 'aaaa', '2222', 'GlOBAl', 'AAAA', 'ffffff', 'wwwww', 'ddddd', 'ww'];
        const expData3 = ['1111', 'aaaa', '2222', 'GlOBAl', 'ffffff', 'wwwww', 'ddddd', 'ww'];
