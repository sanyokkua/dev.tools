...
import {buildWindowsAppInstallCommand, WIN_GET_APPS_LIST, WIN_GET_URL, WIN_GET_WEB_RESOURCES} from "@/tools/win_utils";
...
export default class WindowsSetupPage extends React.Component<any, WindowsSetupState> {
    ...
    onApplicationsAreChosen(values: string[]) {
        if (values && values.length > 0) {
            const result = buildWindowsAppInstallCommand(values);
